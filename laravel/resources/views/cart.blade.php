...
<body>
    ...
    <a class="logo"><h1>Colheita Express</h1></a>
      ...
      <li><a href="{{ asset('produtores.html') }}">Produtores</a></li>
      <li><a href="{{ asset('contato.html') }}">Contato</a></li>
      <li><a href="{{ asset('perfil.html') }}">Perfil</a></li>
      <li><a href="{{ asset('cart.html') }}" class="carrinho-icon">
        <i class="fa-solid fa-cart-shopping"></i>
      <span class="carrinho-item-count"></span></a></li>
      <li><a href="configuracoes.html"><i class="fa-solid fa-gear"></i></a></li>
    </ul>
  </nav>
    </header>
